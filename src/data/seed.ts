...
export const seedState: CampaignState = {
  ...
  milestones: [
    ...
    M('ms-pt-2', 'loo-pt', 'Anchoring workflow validated', '2026-08-10', 'active', 'high', 'Technical Lead', 70, {
      shortLabel: 'Anchoring Validated',
